...
```{r echo=FALSE}
m.female.data <- glmer(QCORRECT ~ TREATMENT + course.grade.frac + (1|QNUM) + (1|ID), 
...
Male-only data
```{r echo=FALSE}
m.male.data <- glmer(QCORRECT ~ TREATMENT + course.grade.frac + (1|QNUM) + (1|ID), 
...
```{r echo=FALSE}
m.control.data <- glmer(QCORRECT ~ Gender + course.grade.frac + (1|QNUM) + (1|ID), 
...
```{r echo=FALSE}
m.gi.f.c <- glmer(QCORRECT ~ TREATMENT*Gender + course.grade.frac + (1|QNUM) + (1|ID), 
                data = dat.trt, 
                family = binomial, control=glmerControl(optimizer="bobyqa"))
m<-m.gi.f.c
print(summary(m))
...
m.gi.f.c <- glmer(QCORRECT ~ TREATMENT*GRELEVEL + course.grade.frac + (1|QNUM) + (1|ID), 
                data = dat.trt, 
                family = binomial, control=glmerControl(optimizer="bobyqa"))
m<-m.gi.f.c
print(summary(m))
...
m.gi.f.c <- glmer(QCORRECT ~ CONTROL*GRELEVEL + course.grade.frac + (1|QNUM) + (1|ID), 
                data = dat.trt, 
                family = binomial, control=glmerControl(optimizer="bobyqa"))
m<-m.gi.f.c
print(summary(m))
...
m.gi.f.t <- glmer(QCORRECT ~ CONTROL*Gender + course.grade.frac + (1|QNUM) + (1|ID), 
                data = dat.trt, 
                family = binomial, control=glmerControl(optimizer="bobyqa"))
m<-m.gi.f.t
print(summary(m))
