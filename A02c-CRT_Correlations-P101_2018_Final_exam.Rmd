...
dat.raw$CRT.medsplit.rev <- 1-dat.raw$CRT.medsplit
...
Low CRT data first
```{r echo=FALSE}
m.crtL.data <- glmer(QCORRECT ~ TREATMENT + final.grade.fix + (1|QNUM) + (1|ID), 
...
High CRT data
```{r echo=FALSE}
m.crtH.data  <- glmer(QCORRECT ~ TREATMENT + final.grade.fix + (1|QNUM) + (1|ID), 
...
```{r echo=FALSE}
m.control.data <- glmer(QCORRECT ~ CRT.medsplit + final.grade.fix + (1|QNUM) + (1|ID), 
...
```{r echo=FALSE}
m.treatment.data <- glmer(QCORRECT ~ CRT.medsplit + final.grade.fix + (1|QNUM) + (1|ID), 
...
```{r echo=FALSE}
m.gi.L.c <- glmer(QCORRECT ~ TREATMENT*CRT.medsplit + final.grade.fix + (1|QNUM) + (1|ID), 
                data = dat.trt, 
                family = binomial, control=glmerControl(optimizer="bobyqa"))
m<-m.gi.L.c
print(summary(m))
...
m.gi.H.c <- glmer(QCORRECT ~ TREATMENT*CRT.medsplit.rev + final.grade.fix + (1|QNUM) + (1|ID), 
                data = dat.trt, 
                family = binomial, control=glmerControl(optimizer="bobyqa"))
m<-m.gi.H.c
print(summary(m))
...
m.gi.L.t <- glmer(QCORRECT ~ CONTROL*CRT.medsplit.rev + final.grade.fix + (1|QNUM) + (1|ID), 
                data = dat.trt, 
                family = binomial, control=glmerControl(optimizer="bobyqa"))
m<-m.gi.L.t
print(summary(m))
...
m.gi.L.t <- glmer(QCORRECT ~ CONTROL*CRT.medsplit + final.grade.fix + (1|QNUM) + (1|ID), 
                data = dat.trt, 
                family = binomial, control=glmerControl(optimizer="bobyqa"))
m<-m.gi.L.t
print(summary(m))
...
| ------------- |------------|-----|
| Treatment (low CRT) | `r tf11` [`r tf12`, `r tf13`] | `r tf14` [`r tf15`, `r tf16`] |
| Treatment (high CRT) | `r tf21`&ast; [`r tf22`, `r tf23`]  |`r tf24`&ast; [`r tf25`, `r tf26`] |
| CRT split (Control) | `r tf31`&ast;&ast;&ast; [`r tf32`, `r tf33`]      | `r tf34`&ast;&ast;&ast; [`r tf35`, `r tf36`] |
| CRT split (Treatment) | `r tf41`&ast;&ast;&ast; [`r tf42`, `r tf43`]      | `r tf44`&ast;&ast;&ast; [`r tf45`, `r tf46`] |


# Some quick checks with NCRT instead of CRT.medsplit

```{r echo=FALSE}
m.control.data <- glmer(QCORRECT ~ TREATMENT*NCRT + final.grade.fix + (1|QNUM) + (1|ID), 
                data = dat.trt, 
                family = binomial, control=glmerControl(optimizer="bobyqa"))
m<-m.control.data
print(summary(m))
